  ...
  <div class="section">
            <a class="item">
              <div class="card">
                <div class="itemLeft">
                  <div class="icon">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" height="4em" width="4em" xmlns="http://www.w3.org/2000/svg">
